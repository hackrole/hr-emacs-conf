  ...
  (setq-default
   ...
   '(
     ...
     '((auto-completion :variables auto-completion-enable-sort-by-usage t
                        ...
                        spacemacs-default-comopany-backends '(company-files company-capf)
     ...
     sql
     docker
     (mu4e :variables mu4e-accounts-alist t)
     )
